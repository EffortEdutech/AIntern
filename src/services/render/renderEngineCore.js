...
class RenderEngineCore {
  ...
  extractMetadata(workEntry) {
    return {
      ...
      approval: {
        approvedAt: workEntry.approved_at,
        approvedBy: workEntry.approved_by_profile?.full_name || null,
        rejectedAt: workEntry.rejected_at,
        rejectedBy: workEntry.rejected_by_profile?.full_name || null,
        rejectionReason: workEntry.rejection_reason || null,
        remarks: workEntry.approval_remarks || null
      },

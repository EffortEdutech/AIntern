...
const ReportCenterPage = lazy(() => import('./pages/report/ReportCenterPage'));
const FinalReportPage = lazy(() => import('./pages/report/FinalReportPage')); // Phase B
...
export const router = createBrowserRouter([
  ...
  { path: '/reports', element: <Auth><ReportCenterPage /></Auth> },
  { path: '/portfolio', element: <Auth><PortfolioPage /></Auth> }, // v1.1 R5
  { path: '/final-report', element: <Auth><FinalReportPage /></Auth> }, // Phase B
